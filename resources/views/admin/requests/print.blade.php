...
<head>
    ...
    <style>
        ...
        @media print { @page { size: A4 {{ $orientation === 'portrait' ? 'portrait' : 'landscape' }}; margin: 20mm; } }
    </style>
</head>
<body>
@php
...
@forelse ($printGroups as $group)
    ...
    <div class="request-block">
        <div class="request-meta">
            <div><strong>Bahagian:</strong> {{ $group['unit'] }}</div>
            <div><strong>Tahun:</strong> {{ implode(', ', $group['years']) ?: '-' }}</div>
        </div>
...
@empty
    <p>Tiada rekod dijumpai untuk penapis yang dipilih.</p>
@endforelse
...
<div class="footer">
    Disediakan oleh: _______________________ <br><br>
    Disemak oleh: _________________________ <br><br>
    Diluluskan oleh: _______________________
</div>
